...
(function ($) {
  ...
  initialize = function () {
    ...
    scroller.find('div').css('width', (scrollerWidth) + 'px');
  ...
  addNav = function(outerMostList) {
    ...
    var backArrow = '&#x25C0;', 
        forwardArrow = '&#x25B6;', 
        nav = $('<li class="navigation"><div><a href="#next" class="next-tab">' + '<i class="fa fa-angle-left" aria-hiddent="true"></i>' + '</a><a href="#previous" class="previous-tab">' + '<i class="fa fa-angle-right" aria-hiddent="true"></i>' + '</a></div></li>'),
        navHeightDiff,
        navPadTop;
